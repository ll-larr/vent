...
export default function UslugiPage() {
  return (
    ...
    >
      <Prose>
        <p>
          Vent Clean обслуживает вентиляцию заведений общепита, офисов, складов и производств в Москве и
      ...
      <Prose className="mt-10">
        ...
        <h2>Как заказать</h2>
        <p>
          Порядок одинаковый для всех четырёх услуг: заявка, видеоосмотр каналов, расчёт с
