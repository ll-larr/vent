...
import { Droplets, Wind, ShieldCheck, Container, Eye, ArrowRight } from '@/lib/icons';
import type { LucideIcon } from 'lucide-react';

export const metadata: Metadata = {
  title: 'Услуги по чистке и обслуживанию вентиляции',
  description:
    'Пять услуг по обслуживанию вентиляции для бизнеса: чистка от жира и от пыли, дезинфекция, мойка вытяжек и зонтов, видеоинспекция каналов. Москва и область.',
...
const CARD_COPY: Record<string, { label: string; blurb: string; Icon: LucideIcon }> = {
  ...
  dezinfekciya: {
    label: 'Дезинфекция',
    blurb: 'Противомикробная обработка после чистки. Снижает микробную нагрузку на стенки воздуховода.',
    Icon: ShieldCheck,
  },
  'vytyazhki-i-zonty': {
    ...
    >
      <Prose>
        <p>
          ...
          области — работаем по этому направлению с 2021 года. Ниже — пять услуг: механическая
          чистка каналов от жира и от пыли, дезинфекция воздуховодов, мойка вытяжек и зонтов
          пищеблоков и видеодиагностика перед началом работ. У каждой — своя методика, цена и
        ...
        <p>
          ...
          чистку каналов от жира, мойку зонтов и дезинфекцию — это три разных работы с отдельной
          ценой, но их удобно заказать одним выездом бригады. В офисе, на складе или на
          производстве чаще нужна только чистка от пыли, а дезинфекцию добавляют при повышенных
          требованиях к чистоте воздуха. Если состояние вентиляции неизвестно — например, объект
          только что взяли в аренду, — начать разумно с видеоинспекции: она показывает, что
          происходит внутри каналов, и по её итогам понятно, какая из остальных четырёх услуг
          нужна и в каком объёме.
        </p>
        <p>
        ...
        <table>
          ...
          <tbody>
            <tr>
              ...
              <td>Дезинфекция, видеоинспекция</td>
            </tr>
            <tr>
              <td>Офис, бизнес-центр</td>
              <td>Чистка от пыли</td>
              <td>Дезинфекция после залива или ремонта</td>
            </tr>
            <tr>
            ...
            <tr>
              ...
              <td>Чистка от пыли, дезинфекция</td>
