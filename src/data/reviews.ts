...
export const REVIEWS: Review[] = [
  {
    ...
    quote:
      'У нас 6 точек в Москве, каждая со своей кухонной вытяжкой. До Vent.team инспекция СЭС каждый раз была событием. Теперь по графику раз в полгода — спокойно и без скрытых сюрпризов в актах.',
    emphasized: 'событием',
  ...
  },
  {
    ...
    quote:
      'Готовились к аудиту FSSC 22000 — нужен был протокол по вентиляции и подтверждённая дезинфекция. Vent.team сделали за 4 дня под ключ, протокол прошёл аудит без вопросов.',
